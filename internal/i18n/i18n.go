...
var translations = map[string]LangMap{
	...
	"en-US": {
		...
		"msg.ap_approved":           "@USR ✅ AP approved",
		...
		"msg.monitor_force_approve": "@USR 🔴⚠️ C forced approval (abnormal AP result)",
